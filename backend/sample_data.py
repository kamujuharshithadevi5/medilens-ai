...
from models import Report, Biomarker, Alert

INITIAL_REPORTS: List[Report] = [
    Report(
        id="REP-2026-001",
        ...
        file_size="2.4 MB",
        biomarkers=[
            Biomarker(name="Fasting Glucose", value=106.0, unit="mg/dL", ref_min=70.0, ref_max=99.0, status="Borderline", description="Measures blood sugar level after fasting"),
            Biomarker(name="Serum Creatinine", value=0.95, unit="mg/dL", ref_min=0.6, ref_max=1.2, status="Normal", description="Indicator of kidney filtration efficacy"),
            Biomarker(name="Blood Urea Nitrogen (BUN)", value=15.0, unit="mg/dL", ref_min=7.0, ref_max=20.0, status="Normal", description="Kidney metabolic waste indicator"),
            Biomarker(name="Estimated GFR", value=98.0, unit="mL/min", ref_min=60.0, ref_max=120.0, status="Normal", description="Glomerular filtration rate"),
            Biomarker(name="Sodium", value=139.0, unit="mEq/L", ref_min=135.0, ref_max=145.0, status="Normal", description="Primary extracellular electrolyte"),
            Biomarker(name="Potassium", value=4.2, unit="mEq/L", ref_min=3.5, ref_max=5.0, status="Normal", description="Essential mineral for heart rhythm"),
            Biomarker(name="Total Calcium", value=9.4, unit="mg/dL", ref_min=8.5, ref_max=10.2, status="Normal", description="Bone and metabolic signaling mineral"),
            Biomarker(name="Albumin", value=4.5, unit="g/dL", ref_min=3.4, ref_max=5.4, status="Normal", description="Liver synthetic capacity marker"),
        ],
        key_findings=[
    ...
    Report(
        ...
        file_size="1.8 MB",
        biomarkers=[
            Biomarker(name="Total Cholesterol", value=218.0, unit="mg/dL", ref_min=125.0, ref_max=200.0, status="Elevated", description="Total circulating serum cholesterol"),
            Biomarker(name="LDL Cholesterol (Calculated)", value=138.0, unit="mg/dL", ref_min=50.0, ref_max=100.0, status="Elevated", description="Low-density lipoprotein / atherogenic carrier"),
            Biomarker(name="HDL Cholesterol", value=58.0, unit="mg/dL", ref_min=40.0, ref_max=80.0, status="Normal", description="High-density protective lipoprotein"),
            Biomarker(name="Triglycerides", value=110.0, unit="mg/dL", ref_min=50.0, ref_max=150.0, status="Normal", description="Blood circulating fats"),
            Biomarker(name="Non-HDL Cholesterol", value=160.0, unit="mg/dL", ref_min=90.0, ref_max=130.0, status="Elevated", description="All atherogenic lipoprotein particles"),
            Biomarker(name="hs-CRP (High-Sensitivity)", value=1.2, unit="mg/L", ref_min=0.0, ref_max=2.0, status="Normal", description="Systemic vascular inflammation marker"),
        ],
        key_findings=[
    ...
    Report(
        ...
        file_size="1.1 MB",
        biomarkers=[
            Biomarker(name="White Blood Cell Count (WBC)", value=6.8, unit="k/uL", ref_min=4.5, ref_max=11.0, status="Normal", description="Total leukocyte defense cells"),
            Biomarker(name="Red Blood Cell Count (RBC)", value=4.9, unit="M/uL", ref_min=4.3, ref_max=5.9, status="Normal", description="Oxygen-carrying red cells"),
            Biomarker(name="Hemoglobin", value=15.2, unit="g/dL", ref_min=13.5, ref_max=17.5, status="Normal", description="Iron-rich oxygen transport protein"),
            Biomarker(name="Hematocrit", value=45.0, unit="%", ref_min=38.8, ref_max=50.0, status="Normal", description="Volume percentage of red blood cells"),
            Biomarker(name="Platelet Count", value=245.0, unit="k/uL", ref_min=150.0, ref_max=450.0, status="Normal", description="Blood clotting and vascular repair fragments"),
            Biomarker(name="Mean Corpuscular Volume (MCV)", value=88.5, unit="fL", ref_min=80.0, ref_max=100.0, status="Normal", description="Average red blood cell size"),
        ],
        key_findings=[
    ...
    Report(
        ...
        file_size="950 KB",
        biomarkers=[
            Biomarker(name="Thyroid Stimulating Hormone (TSH)", value=2.15, unit="uIU/mL", ref_min=0.45, ref_max=4.5, status="Normal", description="Pituitary hormone directing thyroid activity"),
            Biomarker(name="Free T4 (Thyroxine)", value=1.28, unit="ng/dL", ref_min=0.82, ref_max=1.77, status="Normal", description="Active circulating unbound thyroxine"),
            Biomarker(name="Free T3 (Triiodothyronine)", value=3.1, unit="pg/mL", ref_min=2.0, ref_max=4.4, status="Normal", description="Potent metabolic thyroid hormone"),
        ],
        key_findings=[
    ...
    Report(
        ...
        file_size="1.4 MB",
        biomarkers=[
            Biomarker(name="25-OH Vitamin D", value=22.0, unit="ng/mL", ref_min=30.0, ref_max=100.0, status="Low", description="Primary biomarker for systemic Vitamin D stores"),
            Biomarker(name="Vitamin B12", value=485.0, unit="pg/mL", ref_min=200.0, ref_max=900.0, status="Normal", description="Neuro-hematologic cofactor"),
            Biomarker(name="Serum Ferritin", value=78.0, unit="ng/mL", ref_min=30.0, ref_max=400.0, status="Normal", description="Body intracellular iron storage protein"),
            Biomarker(name="Folate (Serum)", value=14.2, unit="ng/mL", ref_min=3.0, ref_max=20.0, status="Normal", description="Cell division and DNA synthesis vitamin"),
        ],
        key_findings=[
    ...
    Report(
        ...
        file_size="820 KB",
        biomarkers=[
            Biomarker(name="ALT (Alanine Aminotransferase)", value=28.0, unit="U/L", ref_min=7.0, ref_max=56.0, status="Normal", description="Liver cellular enzyme"),
            Biomarker(name="AST (Aspartate Aminotransferase)", value=24.0, unit="U/L", ref_min=10.0, ref_max=40.0, status="Normal", description="Enzyme present in liver and muscle tissue"),
            Biomarker(name="Alkaline Phosphatase (ALP)", value=68.0, unit="U/L", ref_min=44.0, ref_max=147.0, status="Normal", description="Biliary tract and bone enzyme"),
            Biomarker(name="Total Bilirubin", value=0.7, unit="mg/dL", ref_min=0.2, ref_max=1.2, status="Normal", description="Heme breakdown byproduct"),
        ],
        key_findings=[
            "Transaminases (ALT/AST) reflect stable hepatocellular integrity.",
            "Biliary markers (ALP, Bilirubin) are unremarkable."
        ],
...
INITIAL_ALERTS: List[Alert] = [
    ...
    Alert(
        ...
        description="All 6 hematologic cell lines and ratios are within healthy standard limits.",
        severity="info",
        date="2026-07-20",
        is_read=True,
